                    ...
                    <div class="col-xl-3 col-md-6">
                        <div class="card card-stats">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col">
                                        <h5 class="card-title text-uppercase text-muted mb-0">Total surat terkirim</h5>
                                        <span class="h2 font-weight-bold mb-0">{{$jumlahSuratKirim}} surat</span>
                                    </div>
                                    <div class="col-auto">
                                ...
                                <p class="mt-3 mb-0 text-sm">
                                    <span class="text-nowrap">Total surat yang telah dikirim oleh pengguna</span>
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-xl-3 col-md-6">
                        <div class="card card-stats">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col">
                                        <h5 class="card-title text-uppercase text-muted mb-0">Total telegram diterima</h5>
                                        <span class="h2 font-weight-bold mb-0">{{$jumlahTelegramMasuk}} telegram</span>
                                    </div>
                                    <div class="col-auto">
                                        <div class="icon icon-shape bg-gradient-primary text-white rounded-circle shadow">
                                            <i class="ni ni-bullet-list-67"></i>
                                ...
                                <p class="mt-3 mb-0 text-sm">
                                    <span class="text-nowrap">Total telegram yang telah diterima oleh pengguna</span>
                                </p>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-3 col-md-6">
                        <div class="card card-stats">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col">
                                        <h5 class="card-title text-uppercase text-muted mb-0">Total telegram dikirim</h5>
                                        <span class="h2 font-weight-bold mb-0">{{$jumlahTelegramKeluar}} telegram</span>
                                    </div>
                                    <div class="col-auto">
                                        <div class="icon icon-shape bg-gradient-primary text-white rounded-circle shadow">
                                            <i class="ni ni-bullet-list-67"></i>
                                ...
                                <p class="mt-3 mb-0 text-sm">
                                    <span class="text-nowrap">Total telegram yang telah dikirim oleh pengguna</span>
                                </p>
                            </div>
                        </div>
                    </div>
            ...
            <div class="col-xl-12">
                <div class="card">
                    <div class="card-header border-0">
                        <div class="row align-items-center">
                            <div class="col-10">
                                <h3 class="mb-0">Surat yang anda kirim </h3>
                            </div>
                        </div>
                    </div>
                    <div class="table-responsive">
                        ...
                        <table class="table align-items-center table-flush">
                            ...
                            <tbody>
                                @foreach($suratTerkirims as $surat)
                                <tr>
                                    <th scope="row">
                                        {{$surat->id}}
                                    </th>
                                    ...
                                    <td>
                                        ...
                                        <a href="" id="modalShow" data-toggle="modal" data-arg="{{$surat->id}}" data-target="#exampleModal"><strong>Lihat</strong></a>
                                    </td>
            ...
            <div class="col-xl-12">
                <div class="card">
                    <div class="card-header border-0">
                        <div class="row align-items-center">
                            <div class="col-10">
                                <h3 class="mb-0">Telegram yang anda terima</h3>
                            </div>
                        </div>
                    </div>
                    <div class="table-responsive">
                        ...
                        <table class="table align-items-center table-flush">
                            ...
                            <tbody>
                                @foreach($telegramMasuk as $surat)
                                <tr>
                                    <th scope="row">
                                        {{$surat->id}}
                                    </th>
            ...
            <div class="col-xl-12">
                <div class="card">
                    <div class="card-header border-0">
                        <div class="row align-items-center">
                            <div class="col-10">
                                <h3 class="mb-0">Telegram yang anda kirim </h3>
                            </div>
                    ...
                    <div class="table-responsive">
                        ...
                        <table class="table align-items-center table-flush">
                            ...
                            <tbody>
                                @foreach($telegramKeluar as $surat)
                                <tr>
                                    <th scope="row">
                                        {{$surat->id}}
                                    </th>
